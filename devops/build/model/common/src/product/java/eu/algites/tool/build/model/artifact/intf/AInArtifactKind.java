...
public enum AInArtifactKind {
	 ...
	 */
	UNCONTROLLED_CORE("(unknown core)", false, false, false, false, false),
	 ...
	 */
	UNCONTROLLED_BOM("(unknown BOM)", false, false, true, false, false),

	/**
	 * General product artifact intended to be productively used somewhere
	 */
	PRODUCT_CORE("PROD", false, true, false, true, false),
	 ...
	 * artifacts
	 */
	TEST_CORE("TST", false, true, false, true, false),

	/**
	 * Aggregator of multiple artifacts
	 */
	AGGREGATOR("AGG", false, true, true, false, true),
	 ...
	 * functionality
	 */
	POLICY("POL", false, true, true, false, true),
	 ...
	 * policy.
	 */
	POLICY_BACKGROUND_BOM("PBBOM", true, true, true, false, false),
	 ...
	 */
	PRODUCT_INTERFACE_BOM("PIBOM", false, true, true, false, false),
	 ...
	 */
	PRODUCT_VARIANT_BOM("PVBOM", false, true, true, false, false),
	;
	...
	/**
	 * Defines if the artifact is the core functionality artifact
	 * (true) or some management artifact kind
	 * @return true if the artifact contains the core functionality
	 *    and false if is for management purpose only
	 */
