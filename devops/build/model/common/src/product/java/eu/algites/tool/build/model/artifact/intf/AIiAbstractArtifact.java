...
public interface AIiAbstractArtifact {
	...
	/**
	 * Gets the coordinated Identification if the artifact. This is the combination of the group Id and the artifact Id base,
	 * obtained by the call of {@link AIsArtifactModelUtils#getArtifactCoordinatedId(String, String)}
	 * @return the coordinated Identification
	 */
	default String getCoordinatedId() {
		return getArtifactCoordinatedId(getArtifactGroupId(), getArtifactIdBase());
	}
