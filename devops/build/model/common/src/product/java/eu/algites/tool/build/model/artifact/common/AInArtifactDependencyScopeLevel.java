...
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.POLICY;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.POLICY_BACKGROUND_BOM;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.PRODUCT_CORE;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.PRODUCT_INTERFACE_BOM;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.PRODUCT_VARIANT_BOM;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.TEST_CORE;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.UNCONTROLLED_BOM;
import static eu.algites.tool.build.model.artifact.common.AInArtifactKind.UNCONTROLLED_CORE;
